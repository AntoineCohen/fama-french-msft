#let textfont = ("New Computer Modern", "XITS", "STIX Two Text")
#let mathfont = ("New Computer Modern Math", "XITS Math", "STIX Two Math")
...
#let preprint = (
  indent: 1.5em,
  type: "preprint",
  margins: (left: 24mm, right: 24mm, top: 30mm, bottom: 40mm),
  leading: 0.5em,
  above: 1.4em,
  below: 0.85em,
  spacing: 1.75em,
