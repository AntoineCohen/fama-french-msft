...
#let elsearticle(
  ...
  let footer = context{
    ...
    if i == 1 {
      ...
      h(1fr)
      let mois-fr = ("Janvier", "Février", "Mars", "Avril", "Mai", "Juin",
                     "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Décembre")
      emph(mois-fr.at(els-date.month() - 1) + " " + str(els-date.year()))
    } else {align(center)[#i]}
  }
  ...
  if els-columns == 1 { body } else { show: columns(els-columns, body) }
}
